<section class="painel_insumos">
    <div class="container">
        <div class="menu_header">
            ...
            <div>
                <form action="index.php?menuop=insumos_medicamentos" method="post" class="form_buscar">
        ...
        <div class="paginacao">
            <?php
                $sqlTotalInsumos = "SELECT insumos_id,insumos_tipo_insumos_id FROM insumos WHERE insumos_tipo_insumos_id=1";
                ...
                echo "<a href=\"?menuop=insumos_medicamentos&pagina_insumos=1\">Início</a> ";

                if ($pagina_insumos>6) {
                    ?>
                        <a href="?menuop=insumos_medicamentos?pagina_insumos=<?php echo $pagina_insumos-1?>"> << </a>
                    <?php
                } 
                ...
                for($i=1;$i<=$totalPaginasInsumos;$i++){
                    ...
                    if ($i >= ($pagina_insumos) && $i <= ($pagina_insumos+5)) {
                        ...
                        if ($i==$pagina_insumos) {
                            ...
                            echo " <a href=\"?menuop=insumos_medicamentos&pagina_insumos=$i\">$i</a> ";
                        } 
                    }          
                }
                ...
                echo " <a href=\"?menuop=insumos_medicamentos&pagina_insumos=$totalPaginasInsumos\">Fim</a>";
            ?>
        </div>
    </div>
</section>
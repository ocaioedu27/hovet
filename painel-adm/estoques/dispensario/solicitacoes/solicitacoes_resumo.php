    ...
    <div class="container">
        <div class="menu_header">
            <div class="menu_user">
                ...
                <?php
                    ...
                    <a href="index.php?menuop=solicitacoes_resumo&<?=$tipo_status_slc['status_slc_status']?>">
        ...
        <div class="paginacao">
            <?php
                ...
                echo "<a href=\"?menuop=solicitacoes_resumo&" . $qualStatus . "&pagina_solicitacoes=1\">Início</a> ";

                if ($pagina_solicitacoes>6) {
                    ?>
                        <a href="?menuop=solicitacoes_resumo&<?=$qualStatus?>&pagina_solicitacoes=<?php echo $pagina_solicitacoes-1?>"> << </a>
                    <?php
                } 
                ...
                for($i=1;$i<=$totalPaginasSlc;$i++){
                    ...
                    if ($i >= ($pagina_solicitacoes) && $i <= ($pagina_solicitacoes+5)) {
                        ...
                        if ($i==$pagina_solicitacoes) {
                            ...
                            echo " <a href=\"?menuop=solicitacoes_resumo&" . $qualStatus . "&pagina_solicitacoes=$i\">$i</a> ";
                        } 
                    }          
                }
                ...
                echo " <a href=\"?menuop=solicitacoes_resumo&$qualStatus&pagina_solicitacoes=$totalPaginasSlc\">Fim</a>";
            ?>
        </div>
    </div>
</section>
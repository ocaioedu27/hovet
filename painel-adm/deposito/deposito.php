                    ...
                    <tr>
                        <td class="operacoes">
                            <div class="operacao">
                                ...
                                <a href="index.php?menuop=editar_deposito&idInsumoDeposito=<?=$dados["id"]?>" id="mostraEditar" style="display: none;">
                                    <button class="btn">
                                        <ion-icon name="create-outline"></ion-icon>
                                    </button>
                                </a>
                            ...
                            <div class="operacao">
                                ...
                                <a href="index.php?menuop=excluir_deposito&idInsumoDeposito=<?=$dados["id"]?>" id="mostraExcluir" style="display: none;">
                                    <button class="btn">
                                        <ion-icon name="trash-outline"></ion-icon>
                                    </button>
                                </a>

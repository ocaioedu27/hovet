...
<div class="container cadastro_all">
    <div class="cards cadastro_dispensario">
        ...
        <form class="form_cadastro" enctype="multipart/form-data" action="index.php?menuop=insert_farm&<?=$qualEstoque?>" method="post">
                    ...
                    <div class="display-flex-cl">
                        <?php
                            $sql_mov = "SELECT 
                                ...
                                WHERE movimentacao='Abastecer a farmácia'";
            ...
            <div id="dados_cad_farm">
                ...
                <div>
                    <div class="form-group valida_movimentacao">
                        ...
                        <div class="display-flex-cl">
                            <label>Farmácia de Destino</label>
                            <select class="form-control" name="farmaciaDestino[]" id="estoquesDestino1">
                                <?=$string_options?>
                            </select>
                        </div>
                    ...
                    <div class="form-group valida_movimentacao">
                        ...
                        <button class="btn" type="button" onclick="adicionaCampoCad(16, null, null, null, null, null, 'estoquesDestino1', 'estoquesDestino')" style="padding: 0;">+</button>
                    </div>
                </div>
            </div>

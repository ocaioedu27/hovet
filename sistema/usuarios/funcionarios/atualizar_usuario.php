    ...
    if (password_verify($senha, $usuario['usuario_senha'])) {
        ...
        if ($qualOperacao != "alterar_senha") {
            ...
            if(mysqli_query($conexao, $sql)){
                ...
                echo " <a href=\"/hovet/sistema/index.php?menuop=editar_usuario&idUsuario=$idUsuario\">Voltar ao formulário de edição</a> <br/>";
        ...
        echo "<script language='javascript'>window.location='/hovet/sistema/index.php?menuop=editar_usuario&idUsuario=". $idUsuario ."';</script>"; 
    }
} else {

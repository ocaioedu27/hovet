...
<html lang="pt-br">
    ...
    <head>
        ...
        <link rel="icon" href="../img/favicon/logo_hovet.ico" type="image/x-icon">
                ...
                switch ($menuop) {
                    ...
                    case 'tp_estoque':
                        ...
                        if (!has_permission($array_permissoes_user, $array_tipos_estoquista_adm_diretor)) {
                            ...
                            include_once("estoques/tipos_estoque/painel.php");
                            break;
                        }
                    ...
                    case 'cad_tp_estoque':
                        ...
                        if (!has_permission($array_permissoes_user, $array_tipos_estoquista_adm_diretor)) {
                            ...
                            include_once("estoques/tipos_estoque/cadastra.php");
                            break;
                        }

                    case 'insert_tp_estoque':
                        ...
                        if (!has_permission($array_permissoes_user, $array_tipos_estoquista_adm_diretor)) {
                            ...
                            include_once("estoques/tipos_estoque/inserir.php");
                            break;
                        }

                    case 'edit_tp_estoque':
                        ...
                        if (!has_permission($array_permissoes_user, $array_tipos_estoquista_adm_diretor)) {
                            ...
                            include_once("estoques/tipos_estoque/editar.php");
                            break;
                        }
                    ...
                    case 'att_tp_estoque':
                        ...
                        if (!has_permission($array_permissoes_user, $array_tipos_estoquista_adm_diretor)) {
                            ...
                            include_once("estoques/tipos_estoque/atualizar.php");
                            break;
                        }

                    case 'excl_tp_estoque':
                        ...
                        if (!has_permission($array_permissoes_user, $array_tipos_estoquista_adm_diretor)) {
                            ...
                            include_once("estoques/tipos_estoque/excluir.php");
                            break;
                        }
                    ...
                    case 'farmacia_resumo':
                        ...
                        if (!has_permission($array_permissoes_user, $array_tipos_estoquista_adm_diretor)) {
                            ...
                            include_once("estoques/farmacia/painel_resumido.php");
                            break;
                        }
                    ...
                    case 'farmacia':
                        ...
                        if (!has_permission($array_permissoes_user, $array_tipos_estoquista_adm_diretor)) {
                            ...
                            include_once("estoques/farmacia/painel.php");
                            break;
                        }
                    ...
                    case 'cad_farm':
                        ...
                        if (!has_permission($array_permissoes_user, $array_tipos_estoquista_adm_diretor)) {
                            ...
                            include_once("estoques/farmacia/cadastrar.php");
                            break;
                        }
                    ...
                    case 'insert_farm':
                        ...
                        if (!has_permission($array_permissoes_user, $array_tipos_estoquista_adm_diretor)) {
                            ...
                            include_once("estoques/farmacia/inserir.php");
                            break;
                        }
                    ...
                    case 'doar_farmacia':
                        ...
                        if (!has_permission($array_permissoes_user, $array_tipos_estoquista_adm_diretor)) {
                            ...
                            include_once("estoques/farmacia/doar.php");
                            break;
                        }
                    ...
                    case 'att_farm':
                        ...
                        if (!has_permission($array_permissoes_user, $array_tipos_estoquista_adm_diretor)) {
                            ...
                            include_once("estoques/farmacia/atualizar.php");
                            break;
                        }
                    ...
                    case 'excl_farm':
                        ...
                        if (!has_permission($array_permissoes_user, $array_tipos_estoquista_adm_diretor)) {
                            ...
                            include_once("estoques/farmacia/excluir.php");
                            break;
                        }
